...
unsafe extern "C" fn get_meminfo(
    mut mem_free_p: *mut libc::c_ulonglong,
    mut mem_inactive_file_p: *mut libc::c_ulonglong,
) -> libc::c_int {
    let mut fd: libc::c_int = open(
        b"/proc/meminfo\0" as *const u8 as *const libc::c_char,
        0 as libc::c_int,
    );
    if fd >= 0 as libc::c_int {
        let mut buf: [libc::c_char; 4096] = [0; 4096];
        let mut buf_size: size_t = full_read(
            fd,
        ...
        if buf_size > 0 as libc::c_int as libc::c_ulong {
            let mut buf_end: *mut libc::c_char = buf
                .as_mut_ptr()
                .offset(buf_size as isize);
            let mut mem_free: libc::c_ulonglong = 0 as libc::c_int as libc::c_ulonglong;
            let mut mem_inactive_file: libc::c_ulonglong = 0 as libc::c_int
                as libc::c_ulonglong;
            let mut line: *mut libc::c_char = buf.as_mut_ptr();
            loop {
                ...
                *p = '\0' as i32 as libc::c_char;
                if sscanf(
                    line,
                    b"MemFree: %llu kB\0" as *const u8 as *const libc::c_char,
                    &mut mem_free as *mut libc::c_ulonglong,
                ) == 1 as libc::c_int
                {
                    mem_free = mem_free
                ...
                if sscanf(
                    line,
                    b"Inactive(file): %llu kB\0" as *const u8 as *const libc::c_char,
                    &mut mem_inactive_file as *mut libc::c_ulonglong,
                ) == 1 as libc::c_int
                {
                    mem_inactive_file = mem_inactive_file
                        .wrapping_mul(1024 as libc::c_int as libc::c_ulonglong);
                }
                line = p.offset(1 as libc::c_int as isize);
            }
            if mem_free > 0 as libc::c_int as libc::c_ulonglong
                && mem_inactive_file > 0 as libc::c_int as libc::c_ulonglong
            {
                *mem_free_p = mem_free;
...
#[no_mangle]
pub unsafe extern "C" fn physmem_claimable(
    mut aggressivity: libc::c_double,
) -> libc::c_double {
    if aggressivity > 0.0f64 {
        let mut mem_free: libc::c_ulonglong = 0;
        let mut mem_inactive_file: libc::c_ulonglong = 0;
        if get_meminfo(&mut mem_free, &mut mem_inactive_file) == 0 as libc::c_int {
            return mem_free as libc::c_double
                + aggressivity * mem_inactive_file as libc::c_double;
        }
    }
...
pub unsafe extern "C" fn physmem_available() -> libc::c_double {
    return physmem_claimable(0.0f64);
}
