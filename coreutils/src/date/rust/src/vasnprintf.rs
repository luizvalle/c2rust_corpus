        ...
        *__errno_location() = 22 as libc::c_int;
                ...
                .wrapping_div(::core::mem::size_of::<libc::c_char>() as libc::c_ulong)
        {
            ...
            if buf_memsize == 18446744073709551615 as libc::c_ulong {
                current_block = 18248587233614665515;
            } else {
            ...
            match current_block {
                ...
                _ => {
                    *__errno_location() = 12 as libc::c_int;
                    current_block = 1291499624189652156;
                }
            }
        }
        match current_block {
            ...
            _ => {
                ...
                's_92: loop {
                    if cp != (*dp).dir_start {
                        ...
                        if augmented_length > allocated {
                            ...
                            if memory_size == 18446744073709551615 as libc::c_ulong {
                                current_block = 7006777126975364318;
                                break;
                            }
                            if result == resultbuf {
                    ...
                    if i == d.count {
                        current_block = 9552496942165973273;
                        break;
                    }
                    if (*dp).conversion as libc::c_int == '%' as i32 {
                        ...
                        *result.offset(length as isize) = '%' as i32 as libc::c_char;
                        ...
                        if (*dp).conversion as libc::c_int == 'n' as i32 {
                            ...
                            let mut prefixes: [libc::c_int; 2] = [0 as libc::c_int, 0];
                            ...
                            match type_0 as libc::c_uint {
                                9 | 10 => {
                                    ...
                                    *fresh15 = 'l' as i32 as libc::c_char;
                                    current_block_91 = 376170632861612492;
                                }
                                ...
                                28 => {
                                    ...
                                    *fresh17 = 'L' as i32 as libc::c_char;
                                    current_block_91 = 14155412868135599428;
                                }
                                _ => {
                                    current_block_91 = 14155412868135599428;
                                }
                            ...
                            loop {
                                ...
                                *__errno_location() = 0 as libc::c_int;
                                ...
                                if count < 0 as libc::c_int {
                                    ...
                                    current_block = 3268311810401718911;
                                    break 's_92;
                                    ...
                                    as libc::c_ulong >= maxlen
                                {
                                    ...
                                    {
                                        current_block = 12991354931722195276;
                                        break 's_92;
                                    }
                        ...
                        if xsum(length, 1 as libc::c_int as size_t) > allocated {
                            ...
                            if memory_size_3 == 18446744073709551615 as libc::c_ulong {
                                ...
                                if memory_3.is_null() {
                                    ...
                                    result = memory_3;
                                    current_block = 12277627916058602397;
                                }
                            }
                        } else {
                            current_block = 12277627916058602397;
