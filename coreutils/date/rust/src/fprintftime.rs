            ...
            match format_char {
                37 => {
                    if f.offset(-(1 as libc::c_int as isize)) != percent {
                        current_block = 8525903481791087848;
                    } else {
                ...
                97 => {
                    if modifier != 0 as libc::c_int {
                        current_block = 1118003657538308465;
                    } else {
                        if change_case {
                            to_uppcase = 1 as libc::c_int != 0;
                            to_lowcase = 0 as libc::c_int != 0;
                        }
                        current_block = 17979983563778067231;
                    }
                }
                65 => {
                    if modifier != 0 as libc::c_int {
                ...
                67 => {
                    if modifier == 'E' as i32 {
                        ...
                        current_block = 2313673625768731713;
                    }
                }
                120 => {
                    if modifier == 'O' as i32 {
                ...
                68 => {
                    if modifier != 0 as libc::c_int {
                        ...
                        current_block = 13050114229843188739;
                    }
                }
                100 => {
                    if modifier == 'E' as i32 {
                        ...
                        current_block = 15884310193644002919;
                    }
                }
                101 => {
                    if modifier == 'E' as i32 {
                        ...
                        digits = 2 as libc::c_int;
                        number_value = (*tp).tm_mday;
                        current_block = 10322553921170480389;
                    }
                }
                70 => {
                    if modifier != 0 as libc::c_int {
                        ...
                        current_block = 17365652883551890922;
                    }
                }
                72 => {
                    if modifier == 'E' as i32 {
                ...
                106 => {
                    if modifier == 'E' as i32 {
                        ...
                        current_block = 7091310090014094228;
                    }
                }
                77 => {
                    if modifier == 'E' as i32 {
                ...
                80 => {
                    ...
                    current_block = 11161084561253952726;
                }
                112 => {
                    current_block = 11161084561253952726;
                }
                ...
                115 => {
                    ...
                    current_block = 7869170368090278958;
                }
                88 => {
                    if modifier == 'O' as i32 {
                        current_block = 1118003657538308465;
                ...
                58 => {
                    ...
                    if *f.offset(colons as isize) as libc::c_int != 'z' as i32 {
                        ...
                        current_block = 7150670681094511278;
                    }
                }
                122 => {
                ...
                _ => {
                    match current_block {
                        2313673625768731713 => {
                            ...
                            current_block = 226931650827617343;
                        }
                        7150670681094511278 => {
                            if (*tp).tm_isdst < 0 as libc::c_int {
                                ...
                                match colons {
                                    0 => {
                                        ...
                                        match current_block {
                                            9136364834649731412 => {
                                                ...
                                                u_number_value = (hour_diff * 100 as libc::c_int + min_diff)
                                                    as libc::c_uint;
                                                current_block = 13254339278442265805;
                                            }
                                            526342907975455362 => {
                                                if sec_diff != 0 as libc::c_int {
                                                    current_block = 6219004681216927520;
                                        ...
                                        current_block = 6494208287747504108;
                                    }
                                    1 => {
                                        current_block = 12303096423297627778;
                                        match current_block {
                                    ...
                                    3 => {
                                        current_block = 526342907975455362;
                                        match current_block {
                                            9136364834649731412 => {
                                                digits = 5 as libc::c_int;
                                                tz_colon_mask = 0 as libc::c_int;
                            ...
                            match current_block {
                                ...
                                1118003657538308465 => {
                                    ...
                                    if !p.is_null() {
                                        ...
                                        if to_lowcase {
                                            fwrite_lowcase(p, percent, _n_10);
                                        } else if to_uppcase {
                                            fwrite_uppcase(p, percent, _n_10);
                                        } else {
                                            fwrite(
