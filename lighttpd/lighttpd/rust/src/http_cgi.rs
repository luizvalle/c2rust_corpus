...
extern "C" {
    ...
    fn http_version_buf(i: http_version_t) -> *const buffer;
...
pub unsafe extern "C" fn http_cgi_local_redir(r: *mut request_st) -> handler_t {
        ...
        && (*r).http_status < 400 as libc::c_int
    {
        ...
        if (*r).loops_per_request as libc::c_int > 5 as libc::c_int {
            log_error(
                (*r).conf.errh,
                b"http_cgi.c\0" as *const u8 as *const libc::c_char,
...
pub unsafe extern "C" fn http_cgi_headers(
    ...
    if (*r).h2_connect_ext == 0 {
        ...
        let v: *const buffer = http_version_buf((*r).http_version);
        rc
            |= cb
                .expect(
                    "non-null function pointer",
            ...
            .is_null()
        {
            rc
                |= cb
                    ...
                    vdata,
                    b"HTTP_SEC_WEBSOCKET_KEY\0" as *const u8 as *const libc::c_char,
                    (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong
                        as uint32_t)
                        .wrapping_sub(1 as libc::c_int as libc::c_uint) as size_t,
                    b"MDAwMDAwMDAwMDAwMDAwMA==\0" as *const u8 as *const libc::c_char,
        ...
        rc
            |= cb
                ...
                vdata,
                b"HTTP_UPGRADE\0" as *const u8 as *const libc::c_char,
                (::core::mem::size_of::<[libc::c_char; 13]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint) as size_t,
        ...
        rc
            |= cb
                ...
                vdata,
                b"HTTP_CONNECTION\0" as *const u8 as *const libc::c_char,
                (::core::mem::size_of::<[libc::c_char; 16]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint) as size_t,
    ...
    match sock_addr_get_family(&(*srv_sock).addr) {
        2 | 10 => {
            if sock_addr_is_addr_wildcard(&(*srv_sock).addr) != 0 {
                ...
                let mut addrlen: socklen_t = ::core::mem::size_of::<sock_addr>()
    ...
    rc
        |= cb
            ...
            (::core::mem::size_of::<[libc::c_char; 12]>() as libc::c_ulong as uint32_t)
                .wrapping_sub(1 as libc::c_int as libc::c_uint) as size_t,
            (*(*r).dst_addr_buf).ptr,
            buffer_clen((*r).dst_addr_buf) as size_t,
        );
    rc
        |= cb
            .expect(
            ...
            li_utostrn(
                buf.as_mut_ptr(),
                ::core::mem::size_of::<[libc::c_char; 47]>() as libc::c_ulong,
                sock_addr_get_port((*r).dst_addr as *const sock_addr) as uintmax_t,
            ),
        );
    n = 0 as libc::c_int as size_t;
