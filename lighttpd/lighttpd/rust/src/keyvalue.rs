...
pub unsafe extern "C" fn pcre_keyvalue_buffer_append(
    ...
    if (*kvb).used & (4 as libc::c_int - 1 as libc::c_int) as libc::c_uint == 0 {
        ck_realloc_u32(
            &mut (*kvb).kv as *mut *mut pcre_keyvalue as *mut *mut libc::c_void,
            (*kvb).used as size_t,
            4 as libc::c_int as size_t,
            ::core::mem::size_of::<pcre_keyvalue>() as libc::c_ulong,
        );
    }
    let fresh0 = (*kvb).used;
    ...
    if ((*kv).code).is_null() {
        ...
        log_error(
            errh,
            b"keyvalue.c\0" as *const u8 as *const libc::c_char,
    ...
    if 0 as libc::c_int != errcode {
        ...
        return 0 as libc::c_int;
    } else if captures > 19 as libc::c_int as libc::c_uint {
        log_error(
            errh,
            b"keyvalue.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn pcre_keyvalue_buffer_append_ctxmatch(
    ...
    if (num as libc::c_int) < (*cache).captures {
