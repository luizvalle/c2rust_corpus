...
pub unsafe extern "C" fn li_base64_dec(
    ...
    let mut un: *const libc::c_uchar = in_0 as *const libc::c_uchar;
    let end: *const libc::c_uchar = un.offset(in_length as isize);
    ...
    while un < end {
        ch = (if (*un as libc::c_int) < 128 as libc::c_int {
            *base64_reverse_table.offset(*un as isize) as libc::c_int
        } else {
            -(1 as libc::c_int)
        }) as int_fast32_t;
        if (ch < 0 as libc::c_int as libc::c_long) as libc::c_int as libc::c_long != 0 {
            ...
            i = i.wrapping_add(1);
            if i & 3 as libc::c_int as libc::c_ulong == 0 as libc::c_int as libc::c_ulong
            {
                *result
                    .offset(
                        out_pos as isize,
    ...
    match if un == end || ch == -(3 as libc::c_int) as libc::c_long
        || *un as libc::c_int != '\0' as i32
    {
        ...
        3 => {
            ...
            *result
            ...
            current_block_20 = 2338817424748881378;
        }
        2 => {
            current_block_20 = 2338817424748881378;
        }
        0 => {
            current_block_20 = 13027688864999176457;
        }
    ...
    if !(out_pos <= out_length) {
        ck_assert_failed(
            b"base64.c\0" as *const u8 as *const libc::c_char,
