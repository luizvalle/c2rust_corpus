...
#[inline]
unsafe extern "C" fn buffer_is_empty(mut b: *const buffer) -> libc::c_int {
    return (b.is_null() || buffer_is_unset(b) != 0) as libc::c_int;
}
#[no_mangle]
...
static mut config_reference: C2RustUnnamed_7 = C2RustUnnamed_7 {
...
#[no_mangle]
#[cold]
pub unsafe extern "C" fn config_plugin_value_to_bool(
...
pub unsafe extern "C" fn config_plugin_value_to_int32(
    ...
    if (*du).type_0 as libc::c_uint == TYPE_STRING as libc::c_int as libc::c_uint {
        ...
        return if *err as libc::c_int == '\0' as i32 && err != (*b).ptr
    ...
    while (*cpk.offset(i as isize)).ktype as libc::c_int != T_CONFIG_UNSET as libc::c_int
    {
        ...
        if !du.is_null() {
            ...
            match (*cpk.offset(i as isize)).ktype as libc::c_int {
                5 | 6 | 7 | 8 | 9 => {
                    current_block_42 = 4656597566353874058;
                    match current_block_42 {
                        8835654301469918283 => {
                            let mut v_1: libc::c_int = config_plugin_value_to_bool(
                                du,
                                -(1 as libc::c_int),
                            );
                            if -(1 as libc::c_int) == v_1 {
                                log_error(
                                    (*srv).errh,
                                    b"configfile-glue.c\0" as *const u8 as *const libc::c_char,
                                ...
                                rc = 0 as libc::c_int;
                                current_block_42 = 11174649648027449784;
                            } else {
                                (*cpv).v.u = v_1 as libc::c_uint;
                                current_block_42 = 10512632378975961025;
                            }
                        }
                        14788920384400900794 => {
                            ...
                            match (*du).type_0 as libc::c_uint {
                                0 => {
                                    ...
                                    if !v.is_null() && *v as libc::c_int != 0 {
                                        ...
                                        if e != v as *mut libc::c_char && *e == 0
                                            ...
                                            && l <= 65536 as libc::c_int as libc::c_long
                                        {
                                            if l == 65536 as libc::c_int as libc::c_long {
                                                l = 65535 as libc::c_int as libc::c_long;
                                            }
                                            (*cpv).v.shrt = l as libc::c_ushort;
                                            current_block_42 = 10512632378975961025;
                                        } else {
                                            current_block_42 = 7746103178988627676;
                                        }
                                    } else {
                                        current_block_42 = 7746103178988627676;
                                    }
                                    match current_block_42 {
                                        ...
                                        _ => {
                                            log_error(
                                                ...
                                                b"got a string but expected a short integer: %s %s\0"
                                                    as *const u8 as *const libc::c_char,
                                                (*cpk.offset(i as isize)).k,
                                                v,
                                            );
                                ...
                                2 => {
                                    (*cpv)
                                        ...
                                        as libc::c_ushort;
                                    if (*(du as *const data_integer)).value >= 0 as libc::c_int
                                        && (*(du as *const data_integer)).value
                                            <= 65536 as libc::c_int
                                    {
                                        if (*(du as *const data_integer)).value
                                            == 65536 as libc::c_int
                                        {
                                            (*cpv).v.shrt = 65535 as libc::c_int as libc::c_ushort;
                                        }
                                        current_block_42 = 10512632378975961025;
                                    } else {
                                        current_block_42 = 9053169197931207550;
                                    }
                                }
                                _ => {
                                    current_block_42 = 9053169197931207550;
                        ...
                        4656597566353874058 => {
                                ...
                                == TYPE_ARRAY as libc::c_int as libc::c_uint
                            {
                                ...
                                match (*cpk.offset(i as isize)).ktype as libc::c_int {
                                    6 => {
                                        current_block_42 = 12436956170600509897;
                                        match current_block_42 {
                                            2540622007506580400 => {
                                    ...
                                    7 => {
                                        current_block_42 = 17379894899278795378;
                                        match current_block_42 {
                                            2540622007506580400 => {
                                                if array_is_vlist((*cpv).v.a) == 0 {
                                                    log_error(
                                    ...
                                    8 => {
                                        current_block_42 = 13089612503621895029;
                                        match current_block_42 {
                                            2540622007506580400 => {
                                                if array_is_vlist((*cpv).v.a) == 0 {
                                                    log_error(
                                    ...
                                    9 => {
                                        current_block_42 = 2540622007506580400;
                                        match current_block_42 {
                                            2540622007506580400 => {
                                                if array_is_vlist((*cpv).v.a) == 0 {
                                                    log_error(
                ...
                1 => {
                    current_block_42 = 12078161146462773701;
                    match current_block_42 {
                        8835654301469918283 => {
                            let mut v_1: libc::c_int = config_plugin_value_to_bool(
                                du,
                ...
                2 => {
                    current_block_42 = 3209366674063970134;
                    match current_block_42 {
                        8835654301469918283 => {
                            let mut v_1: libc::c_int = config_plugin_value_to_bool(
                                du,
                ...
                3 => {
                    current_block_42 = 14788920384400900794;
                    match current_block_42 {
                        8835654301469918283 => {
                            let mut v_1: libc::c_int = config_plugin_value_to_bool(
                                du,
                ...
                4 => {
                    current_block_42 = 8835654301469918283;
                    match current_block_42 {
                        8835654301469918283 => {
                            let mut v_1: libc::c_int = config_plugin_value_to_bool(
                                du,
                ...
                10 | 0 => {}
                12 => {
                    current_block_42 = 4870572260703008243;
                    match current_block_42 {
                        8835654301469918283 => {
                            let mut v_1: libc::c_int = config_plugin_value_to_bool(
                                du,
                ...
                11 => {
                    current_block_42 = 13649324187710407937;
                    match current_block_42 {
                        8835654301469918283 => {
                            let mut v_1: libc::c_int = config_plugin_value_to_bool(
                                du,
...
pub unsafe extern "C" fn config_plugin_values_init(
    ...
    while u < (*(*srv).config_context).used {
        let dc: *const data_config = *((*(*srv).config_context).data).offset(u as isize)
            as *const data_config;
        let ca: *const array = (*dc).value;
            ...
            != T_CONFIG_UNSET as libc::c_int
        {
            ...
            if !du.is_null() {
                ...
                if !((*cpk.offset(i as isize)).scope as libc::c_int
                    == T_CONFIG_SCOPE_CONNECTION as libc::c_int
                    || 0 as libc::c_int as libc::c_uint == u)
                {
                    ...
                    if (*cpk.offset(i as isize)).scope as libc::c_int
                        == T_CONFIG_SCOPE_SOCKET as libc::c_int
                        && ((*dc).comp as libc::c_uint
                            != COMP_SERVER_SOCKET as libc::c_int as libc::c_uint
                                ...
                                != CONFIG_COND_EQ as libc::c_int as libc::c_uint)
                    {
                        log_pri(
                            ...
                            4 as libc::c_int,
                            b"WARNING: %s must be in global scope or $SERVER[\"socket\"] with '==', or else is ignored\0"
                                as *const u8 as *const libc::c_char,
                            (*cpk.offset(i as isize)).k,
                        );
                    }
...
unsafe extern "C" fn config_check_cond_nocache_eval(
    ...
    if buffer_is_empty(l) as libc::c_long != 0 {
        l = &empty_string as *const const_char_buffer as *mut buffer;
    }
    if debug_cond != 0 {
        log_debug(
            (*r).conf.errh,
    ...
    match (*dc).cond as libc::c_uint {
        3 | 1 => {
                    ...
                    != '/' as i32
            {
                ...
                if llen != 0 && llen != dlen {
                    ...
                    current_block_22 = 7245201122033322888;
                } else {
                ...
                match_0
                    ^= if bits != 0 {
                        sock_addr_is_addr_eq_bits(
                            addr,
                            (*r).dst_addr as *const sock_addr,
                            bits,
                        )
                    } else {
                        sock_addr_is_addr_eq(addr, (*r).dst_addr as *const sock_addr)
                    };
                current_block_22 = 7245201122033322888;
            } else {
                current_block_22 = 7056779235015430508;
        ...
        5 | 6 => {
            let mut llen_0: uint_fast32_t = buffer_clen(l) as uint_fast32_t;
            let mut dlen_0: uint_fast32_t = buffer_clen(&(*dc).string) as uint_fast32_t;
            let mut off: uint_fast32_t = if (*dc).cond as libc::c_uint
                == CONFIG_COND_PREFIX as libc::c_int as libc::c_uint
            {
                0 as libc::c_int as libc::c_ulong
            } else {
                llen_0.wrapping_sub(dlen_0)
            };
            match_0 = !(dlen_0 <= llen_0
                && 0 as libc::c_int
                    == memcmp(
                        ((*l).ptr).offset(off as isize) as *const libc::c_void,
                        (*dc).string.ptr as *const libc::c_void,
                        dlen_0,
                    )) as libc::c_int;
        }
