...
static mut http_versions: [buffer; 5] = [buffer {
    ptr: 0 as *mut libc::c_char,
    used: 0,
    size: 0,
}; 5];
static mut http_methods: [buffer; 41] = [buffer {
    ptr: 0 as *mut libc::c_char,
    used: 0,
    size: 0,
}; 41];
static mut http_status: [keyvalue; 63] = [keyvalue {
    key: 0,
    vlen: 0,
    value: 0 as *const libc::c_char,
}; 63];
#[no_mangle]
pub unsafe extern "C" fn http_version_buf(mut i: http_version_t) -> *const buffer {
    return if (i as libc::c_uint as libc::c_ulong)
        < (::core::mem::size_of::<[buffer; 5]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<buffer>() as libc::c_ulong)
    {
        http_versions.as_ptr().offset(i as libc::c_int as isize)
    } else {
        http_versions
            .as_ptr()
            .offset(
...
pub unsafe extern "C" fn http_method_buf(mut i: http_method_t) -> *const buffer {
    return if (i as libc::c_uint as libc::c_ulong)
        < (::core::mem::size_of::<[buffer; 41]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<buffer>() as libc::c_ulong)
...
#[no_mangle]
pub unsafe extern "C" fn http_method_key_get(
...
unsafe extern "C" fn run_static_initializers() {
    http_versions = [
        {
            let mut init = buffer {
                ptr: b"HTTP/1.0\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                used: (::core::mem::size_of::<[libc::c_char; 9]>() as libc::c_ulong
                    as uint32_t)
        ...
        {
            let mut init = buffer {
                ptr: b"HTTP/1.1\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                used: (::core::mem::size_of::<[libc::c_char; 9]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint)
        ...
        {
            let mut init = buffer {
                ptr: b"HTTP/2.0\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                used: (::core::mem::size_of::<[libc::c_char; 9]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint)
        ...
        {
            let mut init = buffer {
                ptr: b"HTTP/3.0\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                used: (::core::mem::size_of::<[libc::c_char; 9]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint)
    ...
    http_methods = [
        {
            let mut init = buffer {
                ...
                used: (::core::mem::size_of::<[libc::c_char; 4]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint)
                    .wrapping_add(1 as libc::c_int as libc::c_uint),
                size: 0 as libc::c_int as uint32_t,
        ...
        },
        {
            let mut init = buffer {
                ...
                used: (::core::mem::size_of::<[libc::c_char; 5]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint)
                    .wrapping_add(1 as libc::c_int as libc::c_uint),
                size: 0 as libc::c_int as uint32_t,
        ...
        {
            let mut init = buffer {
                ptr: b"QUERY\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
                used: (::core::mem::size_of::<[libc::c_char; 6]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint)
                    .wrapping_add(1 as libc::c_int as libc::c_uint),
                size: 0 as libc::c_int as uint32_t,
        ...
        },
        {
            let mut init = buffer {
                ptr: b"DELETE\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                used: (::core::mem::size_of::<[libc::c_char; 7]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint)
                    .wrapping_add(1 as libc::c_int as libc::c_uint),
                size: 0 as libc::c_int as uint32_t,
        ...
        },
        {
            let mut init = buffer {
                ptr: b"CONNECT\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                used: (::core::mem::size_of::<[libc::c_char; 8]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint)
                    .wrapping_add(1 as libc::c_int as libc::c_uint),
                size: 0 as libc::c_int as uint32_t,
        ...
        },
        {
            let mut init = buffer {
                ptr: b"BASELINE-CONTROL\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                used: (::core::mem::size_of::<[libc::c_char; 17]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint)
                    .wrapping_add(1 as libc::c_int as libc::c_uint),
                size: 0 as libc::c_int as uint32_t,
        ...
        },
        {
            let mut init = buffer {
                ptr: b"MKACTIVITY\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                used: (::core::mem::size_of::<[libc::c_char; 11]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint)
                    .wrapping_add(1 as libc::c_int as libc::c_uint),
                size: 0 as libc::c_int as uint32_t,
        ...
        },
        {
            let mut init = buffer {
                ptr: b"MKREDIRECTREF\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                used: (::core::mem::size_of::<[libc::c_char; 14]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint)
                    .wrapping_add(1 as libc::c_int as libc::c_uint),
                size: 0 as libc::c_int as uint32_t,
        ...
        },
        {
            let mut init = buffer {
                ptr: b"MKWORKSPACE\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                used: (::core::mem::size_of::<[libc::c_char; 12]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint)
                    .wrapping_add(1 as libc::c_int as libc::c_uint),
                size: 0 as libc::c_int as uint32_t,
        ...
        },
        {
            let mut init = buffer {
                ptr: b"PROPPATCH\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                used: (::core::mem::size_of::<[libc::c_char; 10]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint)
                    .wrapping_add(1 as libc::c_int as libc::c_uint),
                size: 0 as libc::c_int as uint32_t,
        ...
        },
        {
            let mut init = buffer {
                ptr: b"UPDATEREDIRECTREF\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                used: (::core::mem::size_of::<[libc::c_char; 18]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint)
                    .wrapping_add(1 as libc::c_int as libc::c_uint),
                size: 0 as libc::c_int as uint32_t,
        ...
        },
        {
            let mut init = buffer {
                ptr: b"VERSION-CONTROL\0" as *const u8 as *const libc::c_char
                    as *mut libc::c_char,
                used: (::core::mem::size_of::<[libc::c_char; 16]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint)
                    .wrapping_add(1 as libc::c_int as libc::c_uint),
                size: 0 as libc::c_int as uint32_t,
    ...
    http_status = [
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 13]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 24]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 15]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 16]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 7]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 12]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 34]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 18]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 20]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 17]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 21]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 10]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 14]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 19]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 9]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 27]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 26]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 25]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 11]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        {
            let mut init = keyvalue {
                key: 425 as libc::c_int,
                vlen: (::core::mem::size_of::<[libc::c_char; 14]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
                value: b"425 Too Early\0" as *const u8 as *const libc::c_char,
            };
            init
        },
        {
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 36]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 31]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
        ...
        },
        {
            let mut init = keyvalue {
                ...
                vlen: (::core::mem::size_of::<[libc::c_char; 28]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
