    ...
    match (*a).plain.sa_family as libc::c_int {
        2 => {
            ...
            if (*b).plain.sa_family as libc::c_int == 2 as libc::c_int {
                return ((*a).ipv4.sin_addr.s_addr & nm == (*b).ipv4.sin_addr.s_addr & nm)
                    as libc::c_int
            } else if (*b).plain.sa_family as libc::c_int == 10 as libc::c_int
                && ({
                    ...
                    ((*__a).__in6_u.__u6_addr32[0 as libc::c_int as usize]
                        ...
                        && (*__a).__in6_u.__u6_addr32[2 as libc::c_int as usize]
                            == htonl(0xffff as libc::c_int as uint32_t)) as libc::c_int
                }) != 0
            {
        ...
        10 => {
            ...
            if (*b).plain.sa_family as libc::c_int == 10 as libc::c_int {
                ...
                return match_0;
            } else if (*b).plain.sa_family as libc::c_int == 2 as libc::c_int
                && ({
    ...
    match (*saddr).plain.sa_family as libc::c_int {
        2 => {
            ...
            if 0 as libc::c_int != rc {
                log_error(
                    errh,
                    b"sock_addr.c\0" as *const u8 as *const libc::c_char,
        ...
        0 => {
                ...
                == strcmp(str, b"localhost\0" as *const u8 as *const libc::c_char)
            {
                ...
                (*saddr)
                    .ipv4
                    .sin_addr
                    .s_addr = htonl(0x7f000001 as libc::c_int as in_addr_t);
                (*saddr).ipv4.sin_port = htons(port);
                *len = ::core::mem::size_of::<sockaddr_in>() as libc::c_ulong
                    as socklen_t;
                return 1 as libc::c_int;
            } else {
                ...
                if 10 as libc::c_int == (*saddr).plain.sa_family as libc::c_int {
                    (*saddr).ipv6.sin6_port = htons(port);
                    *len = ::core::mem::size_of::<sockaddr_in6>() as libc::c_ulong
                        as socklen_t;
                } else {
                    (*saddr).ipv4.sin_port = htons(port);
                    *len = ::core::mem::size_of::<sockaddr_in>() as libc::c_ulong
