...
static mut tlast: unix_time64_t = 0;
static mut thp: uint32_t = 0;
...
unsafe extern "C" fn log_buffer_tstr(t: unix_time64_t) {
    let mut tm: tm = tm {
        tm_sec: 0,
        tm_min: 0,
        tm_hour: 0,
...
unsafe extern "C" fn log_buffer_timestamp(b: *mut buffer) {
    if thp != 0 {
        ...
        if (tlast != ts.tv_sec) as libc::c_int as libc::c_long != 0 {
        ...
        if (tlast != log_epoch_secs) as libc::c_int as libc::c_long != 0 {
...
unsafe extern "C" fn log_buffer_vsprintf(
    ...
    aptry = ap.clone();
    n = vsnprintf(s, bsp, fmt, aptry.as_va_list()) as libc::c_uint;
    if n as libc::c_int <= 0 as libc::c_int {
        return;
    }
    if (n as libc::c_ulong) < bsp {
        buffer_truncate(b, blen.wrapping_add(n as libc::c_ulong) as uint32_t);
    } else {
        s = buffer_extend(b, n as size_t);
        vsnprintf(
            s,
    ...
    n = n.wrapping_sub(i);
    let src: *mut libc::c_char = ck_malloc(n as size_t) as *mut libc::c_char;
    memcpy(
        src as *mut libc::c_void,
        s.offset(i as isize) as *const libc::c_void,
        n as libc::c_ulong,
    );
    buffer_truncate(b, blen.wrapping_add(i as libc::c_ulong) as uint32_t);
    buffer_append_string_c_escaped(b, src, n as size_t);
...
unsafe extern "C" fn log_error_write(
    errh: *const log_error_st,
    b: *mut buffer,
    pri: libc::c_int,
) {
...
unsafe extern "C" fn log_va_list(
...
pub unsafe extern "C" fn log_debug(
    ...
    log_va_list(
        ...
        fmt,
        ap.as_va_list(),
        (0 as libc::c_int) << 8 as libc::c_int | 7 as libc::c_int,
    );
}
#[no_mangle]
#[cold]
pub unsafe extern "C" fn log_error(
    ...
    log_va_list(
        ...
        fmt,
        ap.as_va_list(),
        (0 as libc::c_int) << 8 as libc::c_int | 3 as libc::c_int,
    );
}
#[no_mangle]
#[cold]
pub unsafe extern "C" fn log_perror(
    ...
    log_va_list(
        ...
        fmt,
        ap.as_va_list(),
        (1 as libc::c_int) << 8 as libc::c_int | 3 as libc::c_int,
    );
}
#[no_mangle]
#[cold]
pub unsafe extern "C" fn log_pri(
    errh: *mut log_error_st,
    filename: *const libc::c_char,
    line: libc::c_uint,
    pri: libc::c_int,
    ...
    let mut ap: ::core::ffi::VaListImpl;
    ap = args.clone();
    log_va_list(errh, filename, line, fmt, ap.as_va_list(), pri);
}
#[no_mangle]
#[cold]
pub unsafe extern "C" fn log_pri_multiline(
...
pub unsafe extern "C" fn log_set_global_errh(
    ...
    tlast = -(1 as libc::c_int) as unix_time64_t;
    thp = ts_high_precision as uint32_t;
