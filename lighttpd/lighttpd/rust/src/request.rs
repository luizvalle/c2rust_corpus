...
extern "C" {
    ...
    fn http_method_key_get(s: *const libc::c_char, slen: size_t) -> http_method_t;
...
pub const FILE_CHUNK: C2RustUnnamed_0 = 1;
pub const MEM_CHUNK: C2RustUnnamed_0 = 0;
...
pub union C2RustUnnamed_2 {
    pub h2: C2RustUnnamed_4,
    pub h1: C2RustUnnamed_3,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub struct http_header_parse_ctx {
    ...
    pub log_request_header: uint8_t,
    pub id: int8_t,
    pub max_request_field_size: uint32_t,
    pub http_parseopts: libc::c_uint,
}
...
pub const HTTP_HEADER_H2_PROTOCOL: http_header_h2_e = -6;
pub const HTTP_HEADER_H2_SCHEME: http_header_h2_e = -5;
pub const HTTP_HEADER_H2_PATH: http_header_h2_e = -4;
pub const HTTP_HEADER_H2_METHOD: http_header_h2_e = -3;
...
#[cold]
#[inline(never)]
pub unsafe extern "C" fn http_request_state_append(
    b: *mut buffer,
    mut state: request_state_t,
) {
    let p: *const sn = states
        .as_ptr()
        .offset(
            (if state as uint32_t <= CON_STATE_CLOSE as libc::c_int as libc::c_uint {
                state as libc::c_uint
            } else {
                (CON_STATE_CLOSE as libc::c_int + 1 as libc::c_int) as libc::c_uint
            }) as isize,
        );
    buffer_append_string_len(b, (*p).s, (*p).n as size_t);
}
#[no_mangle]
#[cold]
#[inline(never)]
pub unsafe extern "C" fn http_request_state_short(
    mut state: request_state_t,
) -> *const libc::c_char {
    static mut sstates: [libc::c_char; 13] = unsafe {
        *::core::mem::transmute::<&[u8; 13], &[libc::c_char; 13]>(b".qrQRhsWSECx\0")
    };
    return sstates
        .as_ptr()
        .offset(
...
unsafe extern "C" fn http_request_check_line_minimal(
    ...
    let mut i: uint_fast32_t = 0 as libc::c_int as uint_fast32_t;
    while i < len {
        if (*s.offset(i as isize) as libc::c_int == '\0' as i32) as libc::c_int
            as libc::c_long != 0
        {
            return s.offset(i as isize);
        }
        if (*s.offset(i as isize) as libc::c_int == '\r' as i32) as libc::c_int
            as libc::c_long != 0
        {
            return s.offset(i as isize);
        }
...
unsafe extern "C" fn request_check_hostname(host: *mut buffer) -> libc::c_int {
    ...
    if *h as libc::c_int == ':' as i32 {
        if (*h.offset(1 as libc::c_int as isize) as libc::c_int == '\0' as i32)
...
pub unsafe extern "C" fn http_request_host_normalize(
    ...
    if *p as libc::c_int != '[' as i32 {
                ...
                if (0 as libc::c_int as libc::c_long) < port
                    && port
                        <= (32767 as libc::c_int * 2 as libc::c_int + 1 as libc::c_int)
                            as libc::c_long && *e as libc::c_int == '\0' as i32
                {} else {
                    return -(1 as libc::c_int)
                }
            }
        ...
        if light_isdigit(*p as libc::c_int) != 0 {
            static mut laddr: C2RustUnnamed_7 = C2RustUnnamed_7 {
                s: [0; 16],
                n: 0,
            };
        ...
        static mut laddr_0: C2RustUnnamed_6 = C2RustUnnamed_6 {
            s: [0; 46],
            n: 0,
        };
        ...
        if *bracket as libc::c_int != ']' as i32 {
            ...
            if *bracket.offset(2 as libc::c_int as isize) as libc::c_int != '\0' as i32 {
                ...
                if (0 as libc::c_int as libc::c_long) < port
                    && port
                        <= (32767 as libc::c_int * 2 as libc::c_int + 1 as libc::c_int)
                            as libc::c_long && *e_0 as libc::c_int == '\0' as i32
                {} else {
                    return -(1 as libc::c_int)
                }
            }
...
unsafe extern "C" fn http_request_header_line_invalid(
    ...
    if ((*r).conf).log_request_header_on_error() != 0 {
        if !msg.is_null() {
            log_debug(
                (*r).conf.errh,
                b"request.c\0" as *const u8 as *const libc::c_char,
    ...
    match id as libc::c_uint {
        27 => {
                ...
                == 0
            {
                ...
                return 0 as libc::c_int;
            } else if !((*r).http_host).is_null()
                && buffer_eq_slen((*r).http_host, v, vlen) as libc::c_long != 0
            {
                return 0 as libc::c_int
            }
            current_block_35 = 4402189815041780625;
        }
        30 | 31 | 18 | 28 => {
            current_block_35 = 4402189815041780625;
        }
        12 => {
            if (HTTP_VERSION_1_1 as libc::c_int) < (*r).http_version as libc::c_int {
                return http_request_header_line_invalid(
                    r,
                    400 as libc::c_int,
                    b"invalid Connection header with HTTP/2 or later -> 400\0"
            ...
            current_block_35 = 14434620278749266018;
        }
        14 => {
            if (*r).rqst_htags
            ...
            }
    {
        ...
        || HTTP_METHOD_CONNECT as libc::c_int == (*r).http_method as libc::c_int
            && (*uri.offset(0 as libc::c_int as isize) as libc::c_int == ':' as i32
                || light_isdigit(*uri.offset(0 as libc::c_int as isize) as libc::c_int)
                    != 0)
...
pub unsafe extern "C" fn http_request_validate_pseudohdrs(
    ...
    if (HTTP_METHOD_CONNECT as libc::c_int != (*r).http_method as libc::c_int)
        as libc::c_int as libc::c_long != 0
        || ((*r).h2_connect_ext != 0 as libc::c_int) as libc::c_int as libc::c_long != 0
    {
        if scheme == 0 {
            return http_request_header_line_invalid(
                r,
...
pub unsafe extern "C" fn http_request_parse_header(
    ...
    let mut v: *const libc::c_char = (*hpctx).v;
    let klen: uint32_t = (*hpctx).klen;
    let mut vlen: uint32_t = (*hpctx).vlen;
    ...
    if (*hpctx).trailers == 0 {
        if *k as libc::c_int == ':' as i32 {
                ...
                as libc::c_int as libc::c_long != 0
            {
                match klen.wrapping_sub(1 as libc::c_int as libc::c_uint) {
                    ...
                    6 => {
                        ...
                        {
                            (*hpctx).id = HTTP_HEADER_H2_METHOD as libc::c_int as int8_t;
                        ...
                        {
                            (*hpctx).id = HTTP_HEADER_H2_SCHEME as libc::c_int as int8_t;
                        }
                    }
                    8 => {
                        if 0 as libc::c_int
                        ...
                        {
                            (*hpctx)
                                .id = HTTP_HEADER_H2_PROTOCOL as libc::c_int as int8_t;
                        }
                    }
                    9 => {
                        if 0 as libc::c_int
            ...
            match (*hpctx).id as libc::c_int {
                ...
                -3 => {
                    if !((HTTP_METHOD_UNSET as libc::c_int
                        ...
                        as libc::c_long != 0)
                    {
                        (*r).http_method = http_method_key_get(v, vlen as size_t);
                        if HTTP_METHOD_UNSET as libc::c_int
                ...
                -6 => {
                    if vlen != 9 as libc::c_int as libc::c_uint
                        || 0 as libc::c_int
                            != memcmp(
                            ...
                            )
                    {
                        return http_request_header_line_invalid(
                            r,
                            405 as libc::c_int,
                            b"unhandled :protocol value -> 405\0" as *const u8
                                as *const libc::c_char,
                        );
                    }
                    (*r).h2_connect_ext = 1 as libc::c_int;
                    return 0 as libc::c_int;
                }
                _ => {
                    return http_request_header_line_invalid(
            ...
            if (*v as libc::c_int <= 0x20 as libc::c_int) as libc::c_int as libc::c_long
                != 0
            {
            ...
            if (*v.offset(vlen.wrapping_sub(1 as libc::c_int as libc::c_uint) as isize)
                as libc::c_int <= 0x20 as libc::c_int) as libc::c_int as libc::c_long
                != 0
            {
                while *v
                    ...
                    || *v
                        .offset(
                            vlen.wrapping_sub(1 as libc::c_int as libc::c_uint) as isize,
                        ) as libc::c_int == '\t' as i32
                {
                    vlen = vlen.wrapping_sub(1);
                    vlen;
                ...
                as libc::c_int as libc::c_long != 0
            {
                ...
                while ((*k.offset(j as isize) as uint32_t)
                    .wrapping_sub('a' as i32 as libc::c_uint)
            ...
            match *k.offset(i as isize) as libc::c_int {
                ...
                _ => {
                    if if http_header_strict != 0 {
                        ...
                        (*k.offset(i as isize) as libc::c_int == '\0' as i32)
                            as libc::c_int
                    } != 0
                    {
                        return http_request_header_char_invalid(
...
unsafe extern "C" fn http_request_parse_headers(
    ...
    while i < *hoff.offset(0 as libc::c_int as isize) as libc::c_int {
        ...
        if (vlen <= 0 as libc::c_int) as libc::c_int as libc::c_long != 0 {
            if id as libc::c_uint
                == HTTP_HEADER_CONTENT_LENGTH as libc::c_int as libc::c_uint
            {
                return http_request_header_line_invalid(
                    r,
                    400 as libc::c_int,
    ...
    states = [
        {
            let mut init = sn {
                ...
                n: (::core::mem::size_of::<[libc::c_char; 8]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
            };
            init
        },
        {
            let mut init = sn {
                ...
                n: (::core::mem::size_of::<[libc::c_char; 10]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
            };
            init
        },
        {
            let mut init = sn {
                ...
                n: (::core::mem::size_of::<[libc::c_char; 5]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
            };
            init
        ...
        },
        {
            let mut init = sn {
                ...
                n: (::core::mem::size_of::<[libc::c_char; 9]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
            };
            init
        ...
        },
        {
            let mut init = sn {
                ...
                n: (::core::mem::size_of::<[libc::c_char; 6]>() as libc::c_ulong
                    as uint32_t)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
            };
            init
