...
extern "C" {
    ...
    fn li_rand_reseed();
    fn li_rand_cleanup();
    fn http_range_config_allow_http10(flag: libc::c_int);
    ...
    fn fdevent_waitpid_intr(pid: pid_t, status: *mut libc::c_int) -> pid_t;
    ...
    fn sys_setjmp_sigbus(sig: libc::c_int);
    ...
    fn h1_send_1xx(r: *mut request_st, con: *mut connection) -> libc::c_int;
}
...
static mut default_server_tag: buffer = {
    let mut init = buffer {
        ptr: b"lighttpd/1.4.77-devel-lighttpd-1.4.76-25-g51d48de7\0server\0" as *const u8
            as *const libc::c_char as *mut libc::c_char,
        used: ::core::mem::size_of::<[libc::c_char; 51]>() as libc::c_ulong as uint32_t,
...
static mut h1_1_dispatch_table: http_dispatch = unsafe {
    {
        let mut init = http_dispatch {
            process_streams: None,
            upgrade_h2: None,
            upgrade_h2c: None,
            send_100_continue: None,
            send_1xx: Some(
                h1_send_1xx
...
static mut last_sigterm_info: siginfo_t = siginfo_t {
    ...
    si_code: 0,
    __pad0: 0,
    _sifields: C2RustUnnamed_7 { _pad: [0; 28] },
};
...
unsafe extern "C" fn server_main_setup_signals() {
    ...
    act.sa_flags = 0x40000000 as libc::c_int;
    act
        .__sigaction_handler
        .sa_handler = Some(sys_setjmp_sigbus as unsafe extern "C" fn(libc::c_int) -> ());
    ...
    if new_ts_adj < cur_ts || new_ts_adj - cur_ts > 300 as libc::c_int as libc::c_long {
            ...
            }) > delta as libc::c_long
        {
            log_error(
                ...
                b"clock jumped; attempting graceful restart in < ~5 seconds, else hard restart\0"
                    as *const u8 as *const libc::c_char,
            );
            (*srv)
...
unsafe extern "C" fn server_init() -> *mut server {
    let mut srv: *mut server = ck_calloc(
    ...
    log_con_jqueue = &mut log_con_jqueue as *mut *mut connection as uintptr_t
        as *mut connection;
    memset(
        http_dispatch.as_mut_ptr() as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<[http_dispatch; 4]>() as libc::c_ulong,
    );
    return srv;
}
#[cold]
...
unsafe extern "C" fn server_free(mut srv: *mut server) {
    if oneshot_fd > 0 as libc::c_int {
        ...
        if oneshot_fdout >= 0 as libc::c_int {
            ...
            fdevent_socket_close(oneshot_fd);
        }
    }
    if oneshot_fdout >= 0 as libc::c_int {
        close(oneshot_fdout);
    ...
    if (*srv).stdin_fd >= 0 as libc::c_int {
        fdevent_socket_close((*srv).stdin_fd);
    }
...
unsafe extern "C" fn show_version() {
    let mut b: *mut libc::c_char = b"lighttpd/1.4.77-devel-lighttpd-1.4.76-25-g51d48de7 - a light and fast webserver\n\0"
        as *const u8 as *const libc::c_char as *mut libc::c_char;
    write_all(1 as libc::c_int, b as *const libc::c_void, strlen(b));
}
#[cold]
unsafe extern "C" fn show_features() {
    static mut features: [libc::c_char; 411] = unsafe {
        *::core::mem::transmute::<
            &[u8; 411],
            &[libc::c_char; 411],
        >(
...
#[inline(never)]
unsafe extern "C" fn server_main_setup_workers(
    srv: *mut server,
    npids: libc::c_int,
) -> libc::c_int {
    let mut pid: pid_t = 0;
    let mut num_childs: libc::c_int = npids;
    let mut child: libc::c_int = 0 as libc::c_int;
    let mut timer: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let vla = npids as usize;
...
unsafe extern "C" fn server_main_setup(
    ...
    let mut conffile: *const libc::c_char = 0 as *const libc::c_char;
    ...
    if 1 as libc::c_int == (*srv).srvconf.max_worker as libc::c_int {
    ...
    if (*srv).srvconf.max_conns as libc::c_int <= 16 as libc::c_int
        && malloc_top_pad == 524288 as libc::c_int as libc::c_ulong
    {
        malloc_top_pad = 131072 as libc::c_int as size_t;
    }
    if oneshot_fd != 0 {
    ...
    http_range_config_allow_http10(
        config_feature_bool(
            srv,
            b"http10.range\0" as *const u8 as *const libc::c_char,
            0 as libc::c_int,
        ),
    );
    ...
    http_dispatch[HTTP_VERSION_1_1 as libc::c_int as usize] = h1_1_dispatch_table;
    if config_feature_bool(
        srv,
    ...
    {
        http_dispatch[HTTP_VERSION_2 as libc::c_int as usize].send_1xx = None;
    }
    if config_feature_bool(
        srv,
    ...
    {
        http_dispatch[HTTP_VERSION_1_1 as libc::c_int as usize].send_1xx = None;
    }
    if config_feature_bool(
        srv,
        b"server.discard-backend-1xx\0" as *const u8 as *const libc::c_char,
        0 as libc::c_int,
    ) != 0
    {
        http_dispatch[HTTP_VERSION_3 as libc::c_int as usize].send_1xx = None;
        http_dispatch[HTTP_VERSION_2 as libc::c_int as usize].send_1xx = None;
        http_dispatch[HTTP_VERSION_1_1 as libc::c_int as usize].send_1xx = None;
    }
    let mut i: uint32_t = 0 as libc::c_int as uint32_t;
        ...
        if !((*srv).srvconf.username).is_null() {
            ...
            if (*pwd).pw_uid == 0 as libc::c_int as libc::c_uint {
                log_error(
                    ...
                    b"I will not set uid to 0.  Perhaps you should comment out server.username in lighttpd.conf\n\0"
                        as *const u8 as *const libc::c_char,
                );
                return -(1 as libc::c_int);
            }
        ...
        if !grp.is_null() {
            if (*grp).gr_gid == 0 as libc::c_int as libc::c_uint {
                log_error(
                    ...
                    b"I will not set gid to 0.  Perhaps you should comment out server.groupname in lighttpd.conf\n\0"
                        as *const u8 as *const libc::c_char,
                );
                return -(1 as libc::c_int);
            }
    ...
    {
        if !conffile.is_null() && *conffile as libc::c_int != '/' as i32
            && (*conffile.offset(0 as libc::c_int as isize) as libc::c_int != '-' as i32
                || *conffile.offset(1 as libc::c_int as isize) as libc::c_int
                    != '\0' as i32)
        {
            log_pri(
                (*srv).errh,
                ...
                4 as libc::c_int,
                b"(warning) daemonizing without absolute path command line args (graceful restart may fail)\0"
                    as *const u8 as *const libc::c_char,
            );
        }
    ...
    if (*srv).srvconf.preflight_check == 0 {
        ...
        if oneshot_fd == 0 {
            log_pri(
                ...
                5 as libc::c_int,
                b"server started (lighttpd/1.4.77-devel-lighttpd-1.4.76-25-g51d48de7)\0"
                    as *const u8 as *const libc::c_char,
            );
        }
    }
    ...
    if (*srv).srvconf.max_worker as libc::c_int > 0 as libc::c_int {
        let mut rc: libc::c_int = server_main_setup_workers(
            srv,
...
unsafe extern "C" fn server_handle_sighup(srv: *mut server) {
    ...
    log_pri(
        (*srv).errh,
        b"server.c\0" as *const u8 as *const libc::c_char,
        2096 as libc::c_int as libc::c_uint,
        6 as libc::c_int,
...
unsafe extern "C" fn main_init_once() -> libc::c_int {
    ...
    >(
        dlsym(0 as *mut libc::c_void, b"mallopt\0" as *const u8 as *const libc::c_char)
            as intptr_t as libc::intptr_t,
    );
    if mallopt_fn.is_some() {
        mallopt_fn
            .expect("non-null function pointer")(-(8 as libc::c_int), 2 as libc::c_int);
    }
        ...
        if rc > 0 as libc::c_int {
            ...
            if 2 as libc::c_int == graceful_shutdown {
                log_pri(
                    (*srv).errh,
                    b"server.c\0" as *const u8 as *const libc::c_char,
                    2355 as libc::c_int as libc::c_uint,
                    5 as libc::c_int,
