...
#[no_mangle]
pub static mut http_dispatch: [http_dispatch; 4] = [http_dispatch {
...
pub unsafe extern "C" fn http_response_buffer_append_authority(
    ...
    if buffer_is_blank(&mut (*r).uri.authority) == 0 {
                ...
                > ::core::mem::size_of::<sock_addr>() as libc::c_ulong as socklen_t
        {
            ...
            log_perror(
                (*r).conf.errh,
                b"http-header-glue.c\0" as *const u8 as *const libc::c_char,
        ...
        if our_addr.plain.sa_family as libc::c_int == 2 as libc::c_int
            && our_addr.ipv4.sin_addr.s_addr
                == htonl(0x7f000001 as libc::c_int as in_addr_t)
        {
            ...
            if 0 as libc::c_int as libc::c_ulong != lhost_len {
                    ...
                    == sock_addr_nameinfo_append_buffer(o, &mut our_addr, (*r).conf.errh)
                {
                    ...
                    lhost_len = (::core::mem::size_of::<[libc::c_char; 10]>()
                        as libc::c_ulong)
        ...
        if default_port as libc::c_int != listen_port as libc::c_int {
            buffer_append_char(o, ':' as i32 as libc::c_char);
...
pub unsafe extern "C" fn http_response_redirect_to_directory(
    ...
    buffer_append_char(vb, '/' as i32 as libc::c_char);
...
#[no_mangle]
#[cold]
pub unsafe extern "C" fn http_response_delay(con: *mut connection) {
    if config_feature_bool(
        (*con).srv,
        b"auth.delay-invalid-creds\0" as *const u8 as *const libc::c_char,
        1 as libc::c_int,
    ) != 0
    {
...
pub unsafe extern "C" fn strftime_cache_reset() {
    ...
    while i < 16 as libc::c_int {
        ...
        mtime_cache[i as usize]
            .str_0
            .used = ::core::mem::size_of::<[libc::c_char; 30]>() as libc::c_ulong
            as uint32_t;
        mtime_cache[i as usize]
            .str_0
            .size = ::core::mem::size_of::<[libc::c_char; 30]>() as libc::c_ulong
            as uint32_t;
        i += 1;
        i;
    }
...
unsafe extern "C" fn http_response_304(r: *mut request_st) -> handler_t {
    (*r).http_status = 304 as libc::c_int;
    return HANDLER_FINISHED;
}
#[cold]
unsafe extern "C" fn http_response_412(r: *mut request_st) -> handler_t {
...
pub unsafe extern "C" fn http_response_handle_cachable(
        ...
        }
    {
        ...
        if http_etag_matches(etag, (*vb).ptr, (range_request == 0) as libc::c_int) != 0 {
            return (if (*r).http_method as libc::c_int
                <= HTTP_METHOD_QUERY as libc::c_int
            {
                http_response_304(r) as libc::c_uint
            } else {
                http_response_412(r) as libc::c_uint
            }) as libc::c_int;
        }
    } else if (*r).http_method as libc::c_int <= HTTP_METHOD_QUERY as libc::c_int
        && {
            vb = http_header_request_get(
                r,
            ...
            })
    {
        ...
        {
            return http_response_304(r) as libc::c_int;
        }
    }
    return HANDLER_GO_ON as libc::c_int;
}
        ...
        if range.is_null() {
            ...
            if buffer_is_valid_UTF8(b) == 0 {
                ...
                if buffer_is_blank(b) != 0 {
                    ...
                    if !xdocroot.is_null() && (*xdocroot).used != 0 {
                        let xval: *const buffer = if ((*r).conf)
                            .force_lowercase_filenames() == 0
                        {
                            ...
                            if !('-' as i32 != *fresh0 as libc::c_int) {
                                if rpos != pos as *mut libc::c_char {
                                    ...
                                    if *__errno_location() != 0 as libc::c_int
                                        ...
                                        || rpos == range as *mut libc::c_char
                                    {
                                        current_block = 16427017139229673736;
                                    } else {
    ...
    match (*r).state as libc::c_uint {
        5 | 4 => {
            if (*r).resp_body_started == 0 {
                ...
                current_block_8 = 7682278891384177705;
            }
        }
        7 => {
            current_block_8 = 7682278891384177705;
...
unsafe extern "C" fn http_response_append_buffer_simple_accum(
    ...
    return (len < 32768 as libc::c_int as libc::c_long
        ...
        && (*(*r).write_queue.last).file.is_temp as libc::c_int != 0) as libc::c_int;
}
    ...
    if (*r).resp_body_scratchpad >= toread as libc::c_long
        && (toread > 32768 as libc::c_int as libc::c_uint
            || toread >= 8192 as libc::c_int as libc::c_uint
                && !((*r).write_queue.last).is_null()
                && (*(*r).write_queue.last).file.is_temp as libc::c_int != 0)
    {
        if buffer_is_blank(b) == 0 {
        ...
        if (n >= 0 as libc::c_int as libc::c_long) as libc::c_int as libc::c_long != 0 {
            ...
            return 1 as libc::c_int;
        } else if n != -(22 as libc::c_int) as libc::c_long {
            return -(1 as libc::c_int)
        }
    }
    return 0 as libc::c_int;
            ...
            if !(0 as libc::c_int as libc::c_uint == klen) {
                        ...
                        || 200 as libc::c_int == (*r).http_status)
                {
                    ...
                    match id as libc::c_uint {
                        46 => {
                            current_block_64 = 10257332211620502908;
                            match current_block_64 {
                                3581066156556565627 => {
                                                ...
                                                << HTTP_HEADER_CONTENT_LENGTH as libc::c_int == 0
                                    {
                                        ...
                                        if err <= value {
                                            ...
                                            current_block_64 = 2168227384378665163;
                                        }
                                    } else {
                                        current_block_64 = 15652330335145281839;
                                    }
                                }
                                10268776058289630551 => {
                                ...
                                4611645196188390243 => {
                                    if end.offset_from(value) as libc::c_long
                                    ...
                                    {
                                        value = value.offset(7 as libc::c_int as isize);
                                        memcpy(
                                            s
                                                .offset(value.offset_from(s) as libc::c_long as isize)
                        ...
                        50 => {
                            current_block_64 = 10943651313745246662;
                            match current_block_64 {
                                3581066156556565627 => {
                                    if *value as libc::c_int == '+' as i32 {
                                        value = value.offset(1);
                        ...
                        12 => {
                            current_block_64 = 10268776058289630551;
                            match current_block_64 {
                                3581066156556565627 => {
                                    if *value as libc::c_int == '+' as i32 {
                                        value = value.offset(1);
                        ...
                        18 => {
                            current_block_64 = 4611645196188390243;
                            match current_block_64 {
                                3581066156556565627 => {
                                    if *value as libc::c_int == '+' as i32 {
                                        value = value.offset(1);
                        ...
                        14 => {
                            current_block_64 = 3581066156556565627;
                            match current_block_64 {
                                3581066156556565627 => {
                                    if *value as libc::c_int == '+' as i32 {
                                        value = value.offset(1);
                        ...
                        49 => {
                            current_block_64 = 3059221110377644841;
                            match current_block_64 {
                                3581066156556565627 => {
                                    if *value as libc::c_int == '+' as i32 {
                                        value = value.offset(1);
                        ...
                        28 => {}
                        0 => {
                            current_block_64 = 15840990393726149347;
                            match current_block_64 {
                                3581066156556565627 => {
                                    if *value as libc::c_int == '+' as i32 {
                                        value = value.offset(1);
...
pub unsafe extern "C" fn http_response_send_1xx(r: *mut request_st) -> libc::c_int {
    if (http_dispatch[(*r).http_version as usize].send_1xx).is_some()
        && (http_dispatch[(*r).http_version as usize].send_1xx)
            .expect("non-null function pointer")(r, (*r).con) == 0
    {
        return 0 as libc::c_int;
    }
...
pub unsafe extern "C" fn http_response_parse_headers(
    ...
    if (*opts).authorizer == 0
        && (*r).resp_htags & (1 as libc::c_ulong) << HTTP_HEADER_UPGRADE as libc::c_int
            != 0
    {
        (*opts).upgrade = 2 as libc::c_int as uint8_t;
        if (*r).h2_connect_ext != 0 {
            (*r).http_status = 200 as libc::c_int;
            http_header_response_unset(
                r,
                HTTP_HEADER_UPGRADE,
    ...
    } else if ((*r).h2_connect_ext != 0 as libc::c_int) as libc::c_int as libc::c_long
        != 0 && (*r).http_status < 300 as libc::c_int
    {
        http_response_body_clear(r, 0 as libc::c_int);
        (*r).handler_module = 0 as *const plugin;
...
pub unsafe extern "C" fn http_response_read(
    ...
    loop {
        ...
        if ((*opts).parse).is_some() {
            ...
            return HANDLER_FINISHED;
        } else if 0 as libc::c_int == (*r).resp_body_started as libc::c_int {
    ...
    octet_stream = {
        let mut init = buffer {
            ptr: b"application/octet-stream\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
            used: (::core::mem::size_of::<[libc::c_char; 25]>() as libc::c_ulong
                as uint32_t)
                .wrapping_sub(1 as libc::c_int as libc::c_uint)
