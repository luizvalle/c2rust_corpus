...
unsafe extern "C" fn data_config_free(mut d: *mut data_unset) {
    ...
    array_free((*ds).value);
    free((*ds).children.data as *mut libc::c_void);
...
pub unsafe extern "C" fn data_config_init() -> *mut data_config {
    ...
    let mut ds: *mut data_config = ck_calloc(
...
pub unsafe extern "C" fn data_config_pcre_compile(
    ...
    if ((*dc).code).is_null() {
        ...
        log_error(
            errh,
            b"data_config.c\0" as *const u8 as *const libc::c_char,
    ...
    if 0 as libc::c_int != errcode {
        ...
        return 0 as libc::c_int;
    } else if captures > 9 as libc::c_int as libc::c_uint {
        log_error(
            errh,
            b"data_config.c\0" as *const u8 as *const libc::c_char,
